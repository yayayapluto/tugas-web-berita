...
<body class="bg-gray-100 text-gray-800">
  ...
  <section class="container mx-auto px-4 py-8 min-h-screen flex flex-col items-center">
    <div class="bg-white rounded shadow px-8 py-8 w-full md:w-1/2">
      ...
      <p class="text-gray-700 mb-4">Anda yakin ingin menghapus berita berikut?</p>
      <h3 class="text-lg font-bold mb-2 text-gray-700"><?= str_replace("-", " ", $data_berita['judul']) ?></h3>

      <div class="flex justify-between items-center py-2 border-b border-gray-200">
        <div class="w-full">
          <p class="text-gray-700 text-ellipsis text-nowrap overflow-hidden w-2/3 lg:w-full "><?= $data_berita['deskripsi'] ?></p>
        </div>
      </div>
